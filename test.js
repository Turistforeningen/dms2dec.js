...
describe('dms2dec', function() {
  ...
  it('should parse dms strings', function() {
    assert.deepEqual(dms2dec(lat, latRef, lon, lonRef), [latDec, lonDec]);
  });

  it('should parse dms strings without commas', function() {
    var lat = '60/1 21/1 4045/100';
    var lon = '5/1 22/1 1555/100';
  ...
  it('should parse dms strings without spaces', function() {
    var lat = '60/1,21/1,4045/100';
    var lon = '5/1,22/1,1555/100';
  ...
  it('should parse dms arrays of strings', function() {
    var lat = ['60/1', '21/1', '4045/100'];
    var lon = ['5/1' , '22/1', '1555/100'];
  ...
  it('should parse dms arrays of numbers', function() {
    var lat = [60, 21, 40.45];
    var lon = [5 , 22, 15.55];
